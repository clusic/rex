...
module.exports = class Plugin {
  ...
  analysis() {
    const pluginTrees = {};
    const pluginFile = path.resolve(this.cwd, 'config', 'plugin.js');
    const pluginEnvFile = path.resolve(this.cwd, 'config', `plugin.${this.env}.js`);
    ...
    if (typeof pluginExports === 'function') pluginExports = pluginExports(this.app);
    if (typeof pluginEnvExports === 'function') pluginEnvExports = pluginEnvExports(this.app);
